app.controller('PublicacionCtrl',function($scope,$rootScope,$ionicLoading,$filter,$cordovaBadge,EventosService,$q,$ionicPopup,$cordovaCalendar,CONFIG,SuscripcionesFactory,CurrentUser,$cordovaLocalNotification,$ionicPlatform){
  ...
  //   $scope.net = $cordovaNetwork.getNetwork();
  //
  ...
  $scope.getEventos = function(){
    ...
    EventosService.getEventos().success(function(data){
      ...
      data.forEach(function(d){
        ...
        if(d.diffusion == 'todos' || d.diffusion == 'maestros'){
          resultado.push(d);
        }
      });
